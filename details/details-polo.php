...
<head>
  ...
  <title>Premium Cotton Polo Shirt</title>
...
<div class="nav-icons">
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/polo1.png" alt="Premium Cotton Polo Shirt" class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/polo2.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/polo3.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      <h2 class="collection-title">CLOTHING COLLECTION</h2>
      <h1 class="product-title">Premium Cotton Polo Shirt</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Tetap tampil rapi dan stylish dengan Premium Cotton Polo Shirt, kaos
        berkerah yang memberikan kesan semi-formal namun tetap santai. Terbuat
        dari katun pique berkualitas tinggi, polo ini memiliki tekstur lembut
        yang nyaman di kulit dan daya serap keringat yang baik, sehingga tetap
        nyaman digunakan seharian.
      </p>

      <div class="price-section">
        <span class="regular-price">75K</span>
        <span class="member-price">70K <small>Member (Save 5K)</small></span>
      </div>
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <input type="text" id="produk" placeholder="Polo" required />
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>Bahan: Katun pique premium (gramasi 220-250 gsm)</p>
          <p>Permukaan bertekstur halus, breathable, menyerap keringat dengan baik, dan tetap rapi sepanjang hari</p>
          <p>Detail: Kerah rapi dengan kancing depan, jahitan kuat dan tahan lama</p>
        </div>
      </div>
