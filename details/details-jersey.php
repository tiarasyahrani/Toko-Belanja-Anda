...
<head>
  ...
  <title>Performance Dry-Fit Jersey</title>
...
<div class="nav-icons">
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/jersey1.png" alt="Performance Dry-Fit Jersey" class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/jersey2.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/jersey3.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      <h2 class="collection-title">CLOTHING COLLECTION</h2>
      <h1 class="product-title">Performance Dry-Fit Jersey</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Tingkatkan performa olahragamu dengan Performance Dry-Fit Jersey, jersey yang dirancang khusus untuk mendukung
        aktivitas tinggi dengan bahan polyester quick-dry. Teknologi ini membantu menyerap keringat lebih cepat, menjaga
        tubuh tetap kering dan nyaman selama beraktivitas. Materialnya yang ringan dan elastis memastikan pergerakan
        lebih bebas, sementara ventilasi pada bagian tertentu membantu meningkatkan sirkulasi udara. </p>
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <input type="text" id="produk" placeholder="Jersey" required />
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>Bahan: Poliester dry-fit berkualitas tinggi</p>
          <p>Karakteristik: Ringan, cepat kering, anti-bakteri, dan menyerap keringat dengan baik</p>
          <p>Detail: Potongan ergonomis, bahan elastis, sirkulasi udara optimal untuk aktivitas olahraga</p>
        </div>
      </div>
