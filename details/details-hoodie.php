...
<head>
  ...
  <title>Classic Oversized Hoodie</title>
  <link
    rel="stylesheet"
...
<body>
  ...
  <div class="product-container">
    <div class="product-images">
      <img
        src="../imgproduct/hoodie1.png"
        alt="Classic Oversized Hoodie"
        class="main-image" />
      <div class="thumbnail-container">
        <img
          src="../imgproduct/hoodie2.png"
          alt="Fabric Detail"
          class="thumbnail" />
        <img
          src="../imgproduct/hoodie3.png"
    ...
    <div class="product-info">
      ...
      <h1 class="product-title">Classic Oversized Hoodie</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Hoodie Katun Premium kami terbuat dari katun berkualitas tinggi,
        menghadirkan kehangatan dan kenyamanan maksimal. Dengan desain klasik
        dan potongan yang pas, hoodie ini ideal untuk dikenakan saat cuaca
        dingin atau sebagai tambahan gaya dalam tampilan kasual Anda.
        Dilengkapi dengan kantong depan dan tali penyesuai, serta jahitan yang
        kuat untuk daya tahan lebih lama. Cocok dipadukan dengan jeans,
        jogger, atau celana kasual untuk gaya santai yang modern.
      </p>

      <div class="price-section">
        <span class="regular-price">40K</span>
        <span class="member-price">35K <small>Member (Save 5K)</small></span>
      </div>
      <!-- Tombol Order -->
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <textarea
              id="tambahan"
              placeholder="Contoh: Sablon nama di bagian belakang."></textarea>
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>Bahan: Katun fleece premium (gramasi 280-320 gsm)</p>
          <p>
            Lembut, hangat, dan breathable dengan lapisan dalam berbulu halus
            untuk kenyamanan ekstra
          </p>
          <p>
            Detail: Kantong kanguru, tali penyesuai di hoodie, jahitan kuat
            dan rapi
          </p>
        </div>
      </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      sr.reveal(".product-images", {
        delay: 400
      });
      sr.reveal(".product-info", {
        delay: 200
      });
      sr.reveal(".dropdown-section", {
        delay: 500,
        interval: 100
      });
    });
  ...
  <script>
    function kirimWhatsApp() {
      ...
      const nomorTujuan = "+628888094444";
