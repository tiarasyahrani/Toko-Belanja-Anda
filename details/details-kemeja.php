...
<head>
  ...
  <title>Formal & Casual Shirts</title>
...
<body>
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/kemeja1.png" alt="Formal & Casual Shirts" class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/kemeja2.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/kemeja3.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      <h2 class="collection-title">CLOTHING COLLECTION</h2>
      <h1 class="product-title">Formal & Casual Shirts</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Tampil rapi dan elegan dengan Formal & Casual Shirt, kemeja serbaguna
        yang cocok untuk berbagai situasi. Dibuat dari bahan katun berkualitas
        tinggi yang lembut dan tidak mudah kusut, kemeja ini memiliki desain
        modern dengan potongan slim-fit yang pas di badan. Tersedia dalam
        berbagai warna solid maupun motif klasik untuk melengkapi gaya formal
        atau casual Anda.
      </p>
      <div class="price-section">
        <span class="regular-price">80K</span>
        <span class="member-price">75K <small>Member (Save 5K)</small></span>
      </div>
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <input type="text" id="produk" placeholder="Kemeja" required />
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>100% Cotton atau Oxford Premium</p>
          <p>
            Desain slim-fit yang memberikan tampilan elegan,breathable, tidak
            mudah luntur meskipun sering dicuci
          </p>
          <p>
            Detail: Kancing full dengan detail rapi, tersedia dalam warna
            solid dan motif klasik, model lengan panjang dan pendek sesuai
            kebutuhan
          </p>
        </div>
      </div>
