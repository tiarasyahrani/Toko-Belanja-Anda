...
<div class="nav-icons">
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/topi1.png" alt="Classic Baseball Cap" class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/topi3.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/topi2.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      <h2 class="collection-title">CLOTHING COLLECTION</h2>
      <h1 class="product-title">Classic Baseball Cap</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Lindungi kepala dari panas matahari dengan gaya! Classic Baseball Cap
        hadir dengan desain yang simpel namun tetap keren, cocok untuk
        berbagai aktivitas outdoor maupun pelengkap gaya casual. Dibuat dari
        bahan katun twill yang ringan namun tahan lama, serta dilengkapi
        dengan strap belakang yang dapat disesuaikan untuk kenyamanan
        maksimal.
      </p>

      <div class="price-section">
        <span class="regular-price">25K</span>
        <span class="member-price">20K <small>Member (Save 5K)</small></span>
      </div>
      ...
      <div class="dropdown-section">
        ...
        <div id="dimensions-content" class="dropdown-content">
          ...
          <p>
            Size Chart: Lingkar Kepala (cm) <br />
            S: 53-55 | M: 56-58 | L: 59-61 | XL: 62-64
          </p>
        </div>
      </div>
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>Bahan: Drill katun atau kanvas berkualitas tinggi</p>
          <p>
            Kain kokoh namun tetap nyaman, tahan lama, serta memiliki
            ventilasi udara yang baik
          </p>
          <p>
            Detail: Strap adjustable untuk penyesuaian ukuran, desain klasik
            yang cocok untuk berbagai gaya
          </p>
        </div>
      </div>
