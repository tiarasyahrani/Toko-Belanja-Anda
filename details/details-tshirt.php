...
<div class="nav-icons">
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/kaos1.png" alt="Classic Cotton T-Shirt" class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/kaos2.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/kaos3.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      ...
      <p class="description-text">
        T-Shirt Katun Klasik kami terbuat dari 100% katun premium,
        memberikan kenyamanan dan sirkulasi udara terbaik. Didesain dengan
        kesesuaian santai, kaus abadi ini sangat cocok untuk tamasya kasual
        atau melapisi pakaian favorit Anda. Jahitan yang diperkuat memastikan
        daya tahan, sedangkan kain sentuhan lembut menjadikannya penting
        lemari pakaian. Pasangkan dengan jeans, celana pendek, atau jogger
        untuk tampilan sehari-hari yang bergaya.
      </p>

      <div class="price-section">
        <span class="regular-price">65K</span>
        <span class="member-price">60K <small>Member (Save 5K)</small></span>
      </div>
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <input type="text" id="produk" placeholder="T-Shirt" required />
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          ...
          <p>Soft, breathable & lightweight</p>
