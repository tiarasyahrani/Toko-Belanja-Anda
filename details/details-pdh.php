...
<head>
  ...
  <title>Professional PDH Shirt</title>
...
<div class="nav-icons">
  ...
  <div class="product-container">
    <div class="product-images">
      <img src="../imgproduct/pdh1.png" alt="Professional PDH Shirt " class="main-image" />
      <div class="thumbnail-container">
        <img src="../imgproduct/pdh2.png" alt="Fabric Detail" class="thumbnail" />
        <img src="../imgproduct/pdh3.png" alt="Stitching Detail" class="thumbnail" />
      </div>
    </div>
    <div class="product-info">
      <h2 class="collection-title">CLOTHING COLLECTION</h2>
      <h1 class="product-title">Professional PDH Shirt</h1>
      <p class="delivery">🚚 Delivery from 3 days</p>
      <h3 class="description">DESCRIPTION</h3>
      <p class="description-text">
        Buat tampilan kerja atau seragam komunitasmu lebih profesional dengan
        Professional PDH Shirt. Dibuat dari bahan Oxford premium yang memiliki
        tekstur halus namun tetap kuat dan tahan lama. Desainnya yang formal
        namun tetap nyaman membuat kemeja ini cocok digunakan dalam berbagai
        situasi, baik di kantor, kegiatan organisasi, atau acara resmi
        lainnya.
      </p>

      <div class="price-section">
        <span class="regular-price">120K</span>
        <span class="member-price">115K <small>Member (Save 5K)</small></span>
      </div>
      ...
      <div id="orderModal" class="modal-checkout">
        <div class="modal-content">
          ...
          <form id="checkoutForm">
            ...
            <input type="text" id="produk" placeholder="PDH" required />
      ...
      <div class="dropdown-section">
        ...
        <div id="fabric-content" class="dropdown-content">
          <p>
            Bahan: Twill premium atau ripstop (kombinasi katun dan poliester)
          </p>
          <p>
            Kuat, tidak mudah kusut, nyaman digunakan dalam waktu lama, dan
            tahan terhadap gesekan
          </p>
          <p>
            Detail: Saku multifungsi, kancing berkualitas, dan desain formal
            yang elegan
          </p>
        </div>
      </div>
